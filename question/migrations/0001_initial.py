    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(db_column='user_id', db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_question', to='main.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('map_seq', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='문제 번호')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ...
                ('question_seq', models.ForeignKey(db_column='question_seq', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='question_map', to='question.question')),
                ('user_id', models.ForeignKey(db_column='user_id', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='user_map', to='main.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_seq', models.ForeignKey(db_column='question_seq', db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='question_testcase', to='question.question')),
            ],
            options={
